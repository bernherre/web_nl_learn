...
const exercises = stripExports(await readFile(new URL('../js/exercises.js', import.meta.url), 'utf8'));
...
const bundle = `/* Generated browser bundle. Source of truth: learning.js, depth-content.js, supplement-content.js, questions-content.js, starter-content.js, spiral-content.js, number-math-content.js, technical-content.js, exercises.js, profiles.js, verb-atlas.js, content.js and main.js. */\n(function () {\n'use strict';\n${learning}\n${depthContent}\n${supplementContent}\n${questionsContent}\n${starterContent}\n${spiralContent}\n${numberMathContent}\n${technicalContent}\n${exercises}\n${profiles}\n${verbAtlas}\n${content}\n${main}\n})();\n`;
