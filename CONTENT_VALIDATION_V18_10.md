# Content validation V18.10

Status: **passed-with-declared-limitations**
Generated: 2026-08-01T23:21:12.871Z
...
- 1886 verb lemmas; 240 have manually reviewed definitions, contextual synonyms, usage notes and examples.
- 1671 verb lemmas remain explicitly marked as not lexically reviewed; the interface does not present generic text as a definition.
- 10 reading articles and 12 writing tasks.
- 18116 knowledge-graph nodes and 65832 validated relationships across 47 source collections.
...
- **PASS — alle expliciete reviews zijn toegepast:** 240 handmatig nagekeken fiches.
...
- **PASS — nagekeken fiches hebben specifieke definities en geldige metadata:** 240 fiches voldoen.
- **PASS — niet-nagekeken fiches tonen geen verzonnen definities of synoniemen:** 1671 fiches blijven expliciet ongemarkeerd.
- **WARNING — resterende lexicale review:** 1671 werkwoorden hebben vervoegingsinformatie maar nog geen handmatig gevalideerde definitie of synoniemen. Ze worden in de interface niet als gedefinieerd gepresenteerd.
...
- **PASS — synoniemen zijn uniek, contextueel bruikbaar en spreken de verschilnotitie niet tegen:** 240 fiches gecontroleerd.
- **PASS — contextuele verschillen tussen synoniemen zijn uitgelegd voor de nieuwe en diep nagekeken fiches:** 198 fiches hebben een verschilnotitie.
...
- **PASS — CSS en JavaScript hebben cache-busting:** Versie 18.10.0 staat in beide shell-assets.
...
- **PASS — de eerste werkwoordbatch wordt vóór gebruik gebundeld:** Definitiepositie=2280055, aanroeppositie=2753643.

## knowledge-graph

- **PASS — graafversie is gelijk aan de applicatieversie:** Versie 18.10.0.
- **PASS — alle grote inhoudsbanken zijn verbonden:** 18116 nodes en 65832 relaties.
- **PASS — alle relaties verwijzen naar bestaande nodes:** Geen gebroken relaties.
- **PASS — lexicale reviewwachtrij is volledig en controleerbaar:** 1671 werkwoorden in de wachtrij.
