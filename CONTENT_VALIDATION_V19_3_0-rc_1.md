# Content validation V19.3.0-rc.1

Status: **passed**
Generated: 2026-08-02T20:31:18.633Z
...
- **PASS — CSS en JavaScript hebben cache-busting:** Versie 19.3.0-rc.1 staat in beide shell-assets.
...
- **PASS — V19-oefeningen worden vóór gebruik gebundeld:** Definitiepositie=451553, gebruikspositie=483919.
- **PASS — V19-praktijksituaties worden vóór gebruik gebundeld:** Definitiepositie=447638, gebruikspositie=7444662.
- **PASS — de eerste werkwoordbatch wordt vóór gebruik gebundeld:** Definitiepositie=2339849, aanroeppositie=7401605.
- **PASS — de lexicale eindcontrole wordt vóór gebruik gebundeld:** Definitiepositie=7069024, aanroeppositie=7401641.

## knowledge-graph

- **PASS — graafversie is gelijk aan de applicatieversie:** Versie 19.3.0-rc.1.
