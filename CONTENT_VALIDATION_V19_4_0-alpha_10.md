# Content validation V19.4.0-alpha.10

Status: **passed**
Generated: 2026-08-04T22:55:05.985Z
...
- 90 grammar modules across A1-C2 and all original, deep, advanced and source-review layers.
- 22 question modules and 22 level-linked question exercises from A1 through C2.
- 8072 exercises; 24 were newly written from the supplied pedagogical coverage references.
...
- 27289 knowledge-graph nodes and 90155 validated relationships across 58 source collections.
...
- **PASS — C1 en C2 bevatten negen volledige spiraalthema’s:** 18 gevorderde themavarianten met doelen, grammatica, dialoog en minimaal 24 taalitems.

## grammar

- **PASS — grammatica-id’s zijn uniek binnen elke gepubliceerde bank:** 77 zoekbare modules en 13 verdiepingsmodules gecontroleerd.
- **PASS — uitleg, regel en voorbeelden zijn aanwezig:** 90 modules voldoen aan de minimumstructuur.
- **PASS — C1 en C2 hebben een volledige canonieke grammaticalaag:** 19 modules: C1=9, C2=10.
...
- **PASS — C1 en C2 hebben elk vier gevorderde vraagmodules:** 8 modules.
- **PASS — C1 en C2 hebben niveaugebonden vraagtraining:** 12 oefeningen.
- **PASS — alle vraagoefeningen verwijzen naar een bestaande vraagmodule:** 22 geldige koppelingen.

## exercises

- **PASS — oefenbanktotaal is reproduceerbaar:** 8072 oefeningen.
- **PASS — oefening-id’s zijn uniek:** 8072 unieke id's.
- **PASS — antwoorden, opties en feedback zijn controleerbaar:** Geen structureel onvolledige oefening gevonden.
- **PASS — niveauverdeling:** {"A0":356,"A1":1064,"A2":1569,"B1":2259,"B2":2806,"C1":9,"C2":9}
...
- **PASS — vraagonderwerpen:** 22 items (minimum 22).
- **PASS — voornaamwoordelijke bijwoorden:** 22 items (minimum 20).
- **PASS — vraagoefeningen:** 22 items (minimum 22).
...
- **PASS — CSS en JavaScript hebben cache-busting:** Versie 19.4.0-alpha.10 staat in beide shell-assets.
...
- **PASS — V19-oefeningen worden vóór gebruik gebundeld:** Definitiepositie=801715, gebruikspositie=834081.
- **PASS — V19-praktijksituaties worden vóór gebruik gebundeld:** Definitiepositie=797800, gebruikspositie=7892991.
- **PASS — de eerste werkwoordbatch wordt vóór gebruik gebundeld:** Definitiepositie=2690011, aanroeppositie=7855984.
- **PASS — de lexicale eindcontrole wordt vóór gebruik gebundeld:** Definitiepositie=7419186, aanroeppositie=7856020.

## knowledge-graph

- **PASS — graafversie is gelijk aan de applicatieversie:** Versie 19.4.0-alpha.10.
- **PASS — alle grote inhoudsbanken zijn verbonden:** 27289 nodes en 90155 relaties.
...
- **PASS — alle C1-C2-spiraalgrammatica staat als expliciete focus in de graaf:** 54 van 54 focussen.
- **PASS — C1-C2-curriculumfocus is gekoppeld aan canonieke grammatica:** 56 verfijningsrelaties.
- **PASS — gevorderde vragen en oefeningen zijn in de graaf opgenomen:** 8 vraagmodules en 12 oefeningen.
- **PASS — gevorderde vraagmodules zijn aan grammatica gekoppeld:** 17 grammaticale koppelingen.
