# Content validation V19.4.0-alpha.12

Status: **passed**
Generated: 2026-08-12T15:37:20.580Z
...
- 27346 knowledge-graph nodes and 91063 validated relationships across 59 source collections.
...
- **PASS — CSS en JavaScript hebben cache-busting:** Versie 19.4.0-alpha.12 staat in beide shell-assets.
...
- **PASS — V19-oefeningen worden vóór gebruik gebundeld:** Definitiepositie=806239, gebruikspositie=838605.
- **PASS — V19-praktijksituaties worden vóór gebruik gebundeld:** Definitiepositie=802324, gebruikspositie=7915092.
- **PASS — de eerste werkwoordbatch wordt vóór gebruik gebundeld:** Definitiepositie=2694535, aanroeppositie=7860997.
- **PASS — de lexicale eindcontrole wordt vóór gebruik gebundeld:** Definitiepositie=7423710, aanroeppositie=7861033.

## knowledge-graph

- **PASS — graafversie is gelijk aan de applicatieversie:** Versie 19.4.0-alpha.12.
- **PASS — alle grote inhoudsbanken zijn verbonden:** 27346 nodes en 91063 relaties.
...
- **PASS — gevorderde vraagmodules zijn aan grammatica gekoppeld:** 77 grammaticale koppelingen.
