...
- 1886 verb lemmas; 435 have manually reviewed definitions, contextual synonyms, usage notes and examples.
...
- **PASS — alle expliciete reviews zijn toegepast:** 435 handmatig nagekeken fiches.
...
- **PASS — nagekeken fiches hebben specifieke definities en geldige metadata:** 435 fiches voldoen.
...
- **PASS — synoniemen zijn uniek, contextueel bruikbaar en spreken de verschilnotitie niet tegen:** 435 fiches gecontroleerd.
...
- **PASS — CSS en JavaScript hebben cache-busting:** Versie 18.11.0 staat in beide shell-assets.
...
- **PASS — graafversie is gelijk aan de applicatieversie:** Versie 18.11.0.
