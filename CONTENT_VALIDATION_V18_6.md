# Content validation V18.6

Status: **passed-with-declared-limitations**
Generated: 2026-08-01T20:29:03.332Z
...
The complete application structure and all published content banks were checked automatically. Lexical definitions and synonym relations are only claimed as manually reviewed for the 92 marked verb fiches. The remaining atlas entries retain grammatical information but deliberately show no generated definition or synonym list.
...
- **PASS — CSS en JavaScript hebben cache-busting:** Versie 18.6.0 staat in beide shell-assets.
