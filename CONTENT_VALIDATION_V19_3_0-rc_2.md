# Content validation V19.3.0-rc.2

Status: **passed**
Generated: 2026-08-02T20:39:38.181Z
...
- **PASS — CSS en JavaScript hebben cache-busting:** Versie 19.3.0-rc.2 staat in beide shell-assets.
...
- **PASS — V19-oefeningen worden vóór gebruik gebundeld:** Definitiepositie=451622, gebruikspositie=483988.
- **PASS — V19-praktijksituaties worden vóór gebruik gebundeld:** Definitiepositie=447707, gebruikspositie=7444731.
- **PASS — de eerste werkwoordbatch wordt vóór gebruik gebundeld:** Definitiepositie=2339918, aanroeppositie=7401674.
- **PASS — de lexicale eindcontrole wordt vóór gebruik gebundeld:** Definitiepositie=7069093, aanroeppositie=7401710.

## knowledge-graph

- **PASS — graafversie is gelijk aan de applicatieversie:** Versie 19.3.0-rc.2.
