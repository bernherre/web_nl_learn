const CACHE = 'nederlands-gewoon-doen-v15';
const CORE = [
  './', './index.html', './css/styles.css', './js/app.js',
  './js/main.js', './js/learning.js', './js/content.js', './js/depth-content.js', './js/supplement-content.js',
  './js/questions-content.js', './js/starter-content.js', './js/spiral-content.js', './js/number-math-content.js', './js/technical-content.js',
  './js/exercises.js',
