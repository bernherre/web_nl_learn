# Content validation V19.3.0-rc.3

Status: **passed**
Generated: 2026-08-02T20:53:23.643Z
...
- 25349 knowledge-graph nodes and 82078 validated relationships across 50 source collections.
...
- **PASS — CSS en JavaScript hebben cache-busting:** Versie 19.3.0-rc.3 staat in beide shell-assets.
...
- **PASS — V19-oefeningen worden vóór gebruik gebundeld:** Definitiepositie=452893, gebruikspositie=485259.
- **PASS — V19-praktijksituaties worden vóór gebruik gebundeld:** Definitiepositie=448978, gebruikspositie=7446002.
- **PASS — de eerste werkwoordbatch wordt vóór gebruik gebundeld:** Definitiepositie=2341189, aanroeppositie=7402945.
- **PASS — de lexicale eindcontrole wordt vóór gebruik gebundeld:** Definitiepositie=7070364, aanroeppositie=7402981.

## knowledge-graph

- **PASS — graafversie is gelijk aan de applicatieversie:** Versie 19.3.0-rc.3.
- **PASS — alle grote inhoudsbanken zijn verbonden:** 25349 nodes en 82078 relaties.
